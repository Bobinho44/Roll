...
public final class RollCommand extends BCommand {
    ...
    public void onCommandRollDefend(Player sender) {
        ...
        //Gets rolled value
        int rolled = new Random().nextInt((int) max);
